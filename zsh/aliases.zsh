...
alias fstash="python3 $ZSH_HOME/fzf/git_stash.py"
alias gcp="python3 $ZSH_HOME/fzf/git_cherry_pick.py"
...
alias fssh="python3 $ZSH_HOME/fzf/ssh_connect.py"
alias fenv="python3 $ZSH_HOME/fzf/env_browser.py"
alias ffile="python3 $ZSH_HOME/fzf/recent_files.py"
alias fman="python3 $ZSH_HOME/fzf/tldr_browser.py"
alias fapp="python3 $ZSH_HOME/fzf/app_launcher.py"
