...
alias gsb="python3 $ZSH_HOME/fzf/git/git_select_branch.py | tee >(cb)"
alias gb="python3 $ZSH_HOME/fzf/git/git_show_branches.py | tee >(cb)"
alias curb="python3 $ZSH_HOME/fzf/git/get_cur_branch.py | tee >(cb)"
alias glogc='glog $(git branch --show-current)'
